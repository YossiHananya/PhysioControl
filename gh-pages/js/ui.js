...
function showLoading(on){
  ...
  if(!el){
    ...
    el.innerHTML='<div style="background:#fff;border-radius:16px;padding:24px 32px;font-family:Rubik,sans-serif;font-size:15px;color:#052e16;font-weight:600">⏳ טוען...</div>';
