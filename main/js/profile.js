...
function showProfileModal(){
  ...
  const sLabel=sv<2?'0-2 שנות ניסיון':sv<4?'2-4 שנות ניסיון':'4+ שנות ניסיון';
  openModal(`<div class="modal-title">הפרופיל שלי</div>
    <div style="text-align:center;margin-bottom:20px">
      ...
      ${currentUser.role==='physio'?`<div style="margin-top:6px;display:flex;gap:6px;justify-content:center;flex-wrap:wrap">
...
function showScoringInfo(){
  ...
  const rows=[{label:'0-2 שנות ניסיון',max:2050},{label:'2-4 שנות ניסיון',max:2870},{label:'4+ שנות ניסיון',max:4100}];
  ...
  html+='📊 <b>הערכת מטופל</b> — נקודות קבועות לפי כלל<br>';
  html+='🔄 <b>טיפול שוטף</b> — נקודות קבועות לפי כלל<br>';
  html+='📋 <b>כללי</b> — נקודות קבועות לפי כלל<br>';
  html+='⏱ <b>פעולות מנהלתיות</b> — <b>נקודה לכל 30 דקות</b> (דיוק לדקה)';
  html+='</div>';
  ...
  html+='<div style="display:grid;grid-template-columns:1fr 1fr 1fr;background:var(--primary);color:#fff;padding:8px 12px;font-size:12px;font-weight:700"><span>ניסיון</span><span style="text-align:center">מקסימום</span><span style="text-align:left">ערך נקודה</span></div>';
  rows.forEach(r=>{
