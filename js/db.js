...
// ═══ SUPABASE CLIENT ═══
const SUPA_URL='https://YOUR_PHYSIO_SUPABASE_URL.supabase.co';
const SUPA_KEY='YOUR_PHYSIO_SUPABASE_ANON_KEY';
let supa;
...
const SESSION={
  get(){try{return JSON.parse(localStorage.getItem('pc_session'));}catch{return null;}},
  set(v){localStorage.setItem('pc_session',JSON.stringify(v));},
  clear(){localStorage.removeItem('pc_session');}
};
